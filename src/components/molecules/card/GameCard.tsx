...
const GameCard = ({ image, title, date, link }: GameCardProps) => {
  return (
    <Link href={link}>
      <div className="w-[250px] h-[350px] group bg-transparent cursor-pointer perspective">
        <div className="relative w-full h-full duration-1000 preserve-3d group-hover:my-rotate-y-180">
          <div className="absolute backface-hidden w-full h-full">
            ...
            />
            <div className="text-white text-2xl font-semibold p-5 bg-black bg-opacity-85 absolute bottom-0 w-full">
              {title.korean}
            </div>
          </div>
